...
{
  imports = [ (modulesPath + "/installer/scan/not-detected.nix") ../services/vial.nix ];
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/7e577636-9027-4dc9-b9f6-68e3bf36d157";
    fsType = "btrfs";
  };

  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/7034-4BF9";
    fsType = "vfat";
    options = [
      "fmask=0022"
      "dmask=0022"
